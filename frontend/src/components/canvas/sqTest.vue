...
<div id="sq-test">
  ...
  <div id="data">
    <br>
    mousePoint: {{mousePoint}} <br>
    mouseDelta: {{mouseDelta}} <br>
    calc00: {{calc00}}
  </div>
...
export default {
  ...
  data() { return {
    ...
    mouseDelta: null,
    scope: null,
    colors: ['#FF0000', '#FF6700', '#FFA700', '#FFF500', '#A2FF00', '#27FF00', '#00FFA2', '#00FFF0', '#00A2FF', '#001DFF', '#9D00FF', ],
    calc00: null
  }},
  computed: {
